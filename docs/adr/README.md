...
Operational reference (non-ADR): **[TrustNest zero-egress constraint](../trustnest-zero-egress-design-constraint.md)** · **[Document intelligence deep dive](../document-intelligence-deep-dive.md)** · **[device matrix & model IDs](../device-matrix.md)** · **[Rust core dev / CI](../core-development.md)** · **[Android ML Kit OCR adapter](../android/mlkit-ocr-adapter.md)**.
