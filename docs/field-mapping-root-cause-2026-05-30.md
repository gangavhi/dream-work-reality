...
```text
Surname→PATEL | PATEL→PRIYA | Given Name(s)→PRIYA | PRIYA→15/03/1990
```

**After fix:**

```text
Surname→PATEL | Given Name(s)→PRIYA | Date of Birth→15/03/1990 | Nationality→INDIAN
```
...
2. Check **Label → value pairs**:
   - Bad: `PATEL→PRIYA`, `742 OAK STREET→AUSTIN`, `SMITH→JANE`
   - Good: `Surname→PATEL`, `8. Address→742 OAK STREET`
