...
| **Watched-folder polish** | **Deep vs shallow** watch (include subfolders or not), **max files per day** or **throttle** to protect battery, **import queue** with priority, **audit log** of “file X → ingested at T” for watch-driven events. |
