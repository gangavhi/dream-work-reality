...
- A **simple welcome** that explains three ideas in plain language:  
  ...
  - Bring in details by **scanning a document now**, **choosing a photo or file**, or typing yourself.  
...
People should be able to add a document **in the moment** (paper in hand) **or** use something they already saved—both paths lead to the same careful review.
...
- Optional: **Which person does this belong to?** if it wasn’t obvious.  
- The user can see **how this was added** in plain words later—for example **“Captured with camera on [date]”** versus **“From a file you chose.”**

### 5.2.1 Keeping a copy of the scan for later (optional)
